...
# =============================================================================
# Category Groups (user-facing groups for the job form)
# Every VALID_PLACE_TYPE must belong to exactly one group.
# The "other" group is built programmatically from any leftovers.
# =============================================================================
_CATEGORY_GROUPS_NAMED = {
    "car_services": [
        "car_dealer", "car_rental", "car_repair", "car_wash",
        "ebike_charging_station", "electric_vehicle_charging_station",
        "gas_station", "parking", "parking_garage", "parking_lot",
        "rest_stop", "tire_shop", "truck_dealer", "truck_stop",
        "auto_parts_store",
    ],
    "restaurants_and_dining": [
        ...
        "colombian_restaurant", "confectionery", "croatian_restaurant",
        "cuban_restaurant", "czech_restaurant", "danish_restaurant", "deli",
        "dessert_restaurant", "dessert_shop", "dim_sum_restaurant", "diner",
        ...
        "hot_pot_restaurant", "hungarian_restaurant", "ice_cream_shop",
        "indian_restaurant", "indonesian_restaurant", "irish_pub",
        "irish_restaurant", "israeli_restaurant", "italian_restaurant",
        "japanese_curry_restaurant", "japanese_izakaya_restaurant",
        "japanese_restaurant", "juice_shop", "kebab_shop",
        ...
        "pub", "ramen_restaurant", "restaurant", "romanian_restaurant",
    ...
    "beauty_and_wellness": [
        ...
        "foot_care", "hair_care", "hair_salon", "makeup_artist", "nail_salon",
        "sauna", "skin_care_clinic", "spa", "tanning_studio", "tailor",
        "wellness_center", "yoga_studio",
    ],
    "home_services": [
        "electrician", "general_contractor", "locksmith", "moving_company",
        "painter", "plumber", "roofing_contractor",
    ],
    "shopping_and_retail": [
        "asian_grocery_store", "bicycle_store", "book_store",
        ...
        "warehouse_store", "wholesaler", "womens_clothing_store", "florist",
    ],
    "fitness_and_sports": [
        "adventure_sports_center", "arena", "athletic_field", "bowling_alley",
        "cycling_park", "fishing_charter", "fishing_pier", "fishing_pond",
        "fitness_center", "go_karting_venue", "golf_course", "gym",
        "hiking_area", "ice_skating_rink", "indoor_golf_course",
        "miniature_golf_course", "off_roading_area", "paintball_center",
        "playground", "race_course", "skateboard_park", "ski_resort",
    ...
    "entertainment_and_leisure": [
        ...
        "banquet_hall", "barbecue_area", "botanical_garden", "casino",
        "childrens_camp", "city_park", "comedy_club", "community_center",
        "concert_hall", "convention_center", "cultural_center", "dance_hall",
        "dog_park", "event_venue", "ferris_wheel", "garden",
        "indoor_playground", "internet_cafe", "karaoke", "live_music_venue",
        "marina", "movie_rental", "movie_theater", "national_park",
        "night_club", "observation_deck", "opera_house", "park",
        "philharmonic_hall", "picnic_ground", "planetarium", "plaza",
        "roller_coaster", "state_park", "tourist_attraction", "video_arcade",
        "vineyard", "visitor_center", "water_park", "wedding_venue",
        "wildlife_park", "wildlife_refuge", "zoo", "summer_camp_organizer",
    ],
    "arts_and_culture": [
        "art_gallery", "art_museum", "art_studio", "auditorium", "castle",
        "cultural_landmark", "fountain", "historical_place", "historical_landmark",
        "history_museum", "monument", "museum", "performing_arts_theater",
        "sculpture",
    ],
    "education": [
        "academic_department", "educational_institution", "library",
        "preschool", "primary_school", "research_institute", "school",
        "secondary_school", "university", "school_district",
    ],
    "financial_services": [
        "accounting", "atm", "bank", "finance", "insurance_agency",
    ],
    "professional_services": [
        "business_center", "catering_service", "chauffeur_service",
        "child_care_agency", "consultant", "corporate_office",
        "courier_service", "coworking_space", "employment_agency",
        "laundry", "lawyer", "marketing_consultant",
        "non_profit_organization", "real_estate_agency", "service",
        "shipping_service", "storage",
        "telecommunications_service_provider",
    ],
    "pet_services": [
        "pet_boarding_service", "pet_care", "veterinary_care",
    ],
    "travel_and_transport": [
        "aircraft_rental_service", "airport", "airstrip",
        "bike_sharing_station", "bridge", "bus_station", "bus_stop",
        ...
        "tour_agency", "tourist_information_center", "train_station",
        "train_ticket_office", "tram_stop", "transit_depot",
        "transit_station", "transit_stop", "transportation_service",
        "travel_agency",
    ],
    "religious_places": [
        "buddhist_temple", "church", "hindu_temple", "mosque",
        "place_of_worship", "shinto_shrine", "synagogue",
    ],
    ...
    "nature_and_outdoors": [
        ...
        "river", "scenic_spot", "woods",
    ],
    "agriculture_and_industry": [
        "farm", "manufacturer", "ranch", "supplier", "television_studio",
    ],
}

# Build "other" catch-all from any VALID_PLACE_TYPES not in a named group
_all_grouped = set()
for _members in _CATEGORY_GROUPS_NAMED.values():
    _all_grouped.update(_members)

_other = [t for t in VALID_PLACE_TYPES if t not in _all_grouped]

CATEGORY_GROUPS = {**_CATEGORY_GROUPS_NAMED}
if _other:
    CATEGORY_GROUPS["other"] = _other
